...
public class BanHang extends javax.swing.JInternalFrame {
    ...
    private ArrayList<String> listMaImeiHuyHD = new ArrayList<>();
...
//    }
    ...
    private void initComponents() {
        ...
        btnClearGH1 = new javax.swing.JButton();
        ...
        btnClearGH = new javax.swing.JButton();
        ...
        btnClearGH1.setText("Search");
        btnClearGH1.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                btnClearGH1FocusGained(evt);
            }
        });
        btnClearGH1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnClearGH1ActionPerformed(evt);
            }
        });
        ...
        btnSearchLayout.setHorizontalGroup(
            ...
            .addGroup(btnSearchLayout.createSequentialGroup()
                ...
                .addComponent(btnClearGH1, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        btnSearchLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnSearchLayout.createSequentialGroup()
                ...
                .addGroup(btnSearchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel19)
                    .addComponent(btnClearGH1, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE))
                .addGap(18, 18, 18)
        ...
        btnClearGH.setText("Làm mới");
        btnClearGH.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnClearGHActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnClearGH, javax.swing.GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void addMaSPHuy_List() {
        listMaSPHuyHD.clear();
        for (int i = 0; i < tblGioHang.getRowCount(); i++) {
            listMaSPHuyHD.add(tblGioHang.getValueAt(i, 1).toString());
        }
    }

    private void addImeiHuyHDClick_List() {
        addMaSPHuy_List();
        listMaImeiHuyHD.clear();
        for (int i = 0; i < tblGioHang.getRowCount(); i++) {
            // duyệt qua từng phần tử của hdct trong giỏ hàng để lấy imei của hdct
            int soImeiDaBanHuyHD = hdctRepository.LayImeiDaBanHuy(listMaSPHuyHD.get(i), layMaHD()).size();
            for (int i1 = 0; i1 < soImeiDaBanHuyHD; i1++) {
                listMaImeiHuyHD.add(hdctRepository.LayImeiDaBanHuy(listMaSPHuyHD.get(i), layMaHD()).get(i1).getMaImeiDaBan());
            }
        }
    }
//
//    public Integer layIDHD_CLick() {
//        int index = tblHoaDonTro.getSelectedRow();
//        String maHD = tblHoaDonTro.getValueAt(index, 1).toString();
//        HoaDonTro hd = hdctRepository.getHD_ClickTheoMa(maHD).get(0);
//        return hd.getIdHoaDon();
//
//    }

    private void xoaAllSpBanHang() {
        addImeiHuyHDClick_List();
        for (int i = 0; i < listMaImeiHuyHD.size(); i++) {
            hdctRepository.updateTrangThaiImei(listMaImeiHuyHD.get(i));
        }
        for (int i = 0; i < listMaSPHuyHD.size(); i++) {
            hdctRepository.updateSoLuongSPXoa(
                    hdctRepository.getTongImeiTheoMaSP(listMaSPHuyHD.get(i)).get(0).getSoLuongImei(),
                    listMaSPHuyHD.get(i));
        }
        for (int i = 0; i < listMaImeiHuyHD.size(); i++) {
            hdctRepository.xoaImeiDaBan(listMaImeiHuyHD.get(i));
        }
        hdctRepository.updateSoLuongHDCT_Huy(getIdHoaDonByMa(layMaHD()));
        hdctRepository.updateTongTien(0, layMaHD());
        for (int i = 0; i < listMaSPHuyHD.size(); i++) {
            hdctRepository.XoaAllHDCTGioHang(hdctRepository.getHDCTClick_TheoMaHDMaSP(layMaHD(),
                    listMaSPHuyHD.get(i)).get(0).getIdHoaDonChiTiet());
        }
        return;
    }
    ...
    private void btnHuyHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHuyHoaDonActionPerformed
        int indexHuyHoaDon = tblHoaDonTro.getSelectedRow();
        if (indexHuyHoaDon < 0) {
    ...
    private void btnClearGH1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearGH1ActionPerformed
        this.showDataTableSP(banhangRepository.getAll(getFormSearch()));
    }//GEN-LAST:event_btnClearGH1ActionPerformed
    ...
    private javax.swing.JButton btnClearGH;
    private javax.swing.JButton btnClearGH1;
